...
# Special thanks to Alex Mayfield and Teemu Piipo - this module yanked from https://bitbucket.org/crimsondusk/pyskull 
#
# I'm lazy and *really* didn't want to do a Huffman implementation myself...  -Skip
